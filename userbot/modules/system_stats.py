...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╚══════════╬════╬══════════╝ \n"
        f"🔰 : [REPO KIO](https://github.com/kiyyawo/KIO-BOT)\n👥 : [KIO-𝗧𝗘𝗔𝗠](t.me/paradoxserver1)\n👤 : [𝗢𝗪𝗡𝗘𝗥](t.me/kiyyawo)\n"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def redis(alive):
    ...
    output = (
        ...
        f"╭═───────╼⌘╾───────═ \n"
        f"┃[𝗥𝗲𝗽𝗼](https://github.com/KIO-BOT)  |  [𝗦𝘂𝗽𝗽𝗼𝗿𝘁](t.me/paradoxserver1)  |  "
        f"[𝗜𝗻𝘀𝘁𝗮𝗴𝗿𝗮𝗺](https://Instagram.com/kiyyawo)\n"
        f"╰═──────╼═⌘═╾───────═")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
